...
const CommitmentCard = ({ text, hasBorder = false }: CommitmentCardProps) => (
  <div
    className={cn(
      'flex flex-col lg:flex-row flex-1 gap-10 items-center lg:items-center lg:pl-5 pr-14 py-16 lg:py-5 min-w-0 w-full relative',
  ...
  >
    <div className="flex gap-10 items-center lg:w-auto w-full justify-center">
      <p className="font-sans font-normal text-base leading-6 text-quaternary-800 flex-1 text-left">
        {text}
      </p>
    </div>
    {hasBorder && (

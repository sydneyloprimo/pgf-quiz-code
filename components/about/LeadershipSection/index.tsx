...
const LeadershipSection = () => {
  ...
  return (
    <section className="w-full h-[100vw] md:h-[40vw] pt-14 px-5 md:px-24 flex flex-col md:flex-row gap-0 items-stretch justify-start">
      <div className="w-full md:w-2/5 flex-shrink-0 relative overflow-hidden aspect-square">
        <Image
      ...
      <div className="w-full md:w-3/5 h-full bg-neutral-400 px-10 md:px-24 flex flex-col justify-center gap-4 md:gap-8 relative">
        <div className="flex flex-col gap-4">
          <p className="font-sans text-base leading-6 text-secondary-950 mb-2.5">
        ...
        <div className="flex items-center justify-end md:justify-start mt-8">
          <p className="font-sans font-bold text-base leading-6 text-secondary-950 text-right md:text-left">
            {t('signature')}
          </p>
        </div>
        <div
